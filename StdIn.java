...
public final class StdIn {
    ...
    private static InputStream keyboard = System.in;
   ...
   /**
    ...
    /**
     * Sets filename as the new input source.
     * 
     * @param filename - the new input source
     */
	public static void setInput(String filename){
		try {												//an accomodation to recieve standard input into eclipse.
